...
public class Question implements HasCreatedDate {
	...
	@CollectionTable(name = "question_content_holder", joinColumns = @JoinColumn(name = "question_id", unique = true, foreignKey = @ForeignKey(name = "fk_question_content_holder_question_id")))
	@Lob
	...
	@JoinTable(name = "question_tag", joinColumns = @JoinColumn(name = "question_id", foreignKey = @ForeignKey(name = "fk_question_tag_question_id")), inverseJoinColumns = @JoinColumn(name = "tag_id", foreignKey = @ForeignKey(name = "fk_question_tag_tag_id")))
	...
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "question_sns_connections", joinColumns = @JoinColumn(name = "question_id", foreignKey = @ForeignKey(name = "fk_question_sns_connection_question_id")))
	...
	public Question(Long id, SocialUser loginUser, String title,
			String contents, Set<Tag> newTags) {
		this.questionId = id;
	...
	public SnsConnection connected(String postId, String groupId) {
		SnsConnection snsConnection = new SnsConnection(
				ProviderType.valueOf(writer.getProviderId()), postId, groupId);
