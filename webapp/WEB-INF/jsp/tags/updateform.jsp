...
<section class="write-content">
	<div class="content-main">
		<h1 class="write-title">태그 수정 요청</h1>
		<form:form modelAttribute="tag" cssClass="form-write" action="/tags" method="PUT">
			<form:hidden path="email"/>
			<form:hidden path="name"/>
			<fieldset>
				<div class="box-input-line">
					태그 관리자 이메일 : ${tag.email}
				</div>
				<div class="box-input-line">
					태그명 : ${tag.name}
				</div>
				...
				<div class="submit-write">
					<button type="submit" class="btn-submit"><i class="icon-submit"></i> 수정 요청</button>
				</div>
			</fieldset>
		</form:form>
	</div>
